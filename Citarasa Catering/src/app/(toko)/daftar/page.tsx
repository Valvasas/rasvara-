    ...
    <div className="container mx-auto px-4 py-12 max-w-md">
      <div className="bg-white rounded-3xl border border-krem-gelap p-6 sm:p-10 shadow-sm space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-daun-lembut text-daun-tua mx-auto flex items-center justify-center text-2xl font-bold">
            ✨
          </div>
          <h1 className="text-2xl font-extrabold text-kayu">Daftar Akun</h1>
