...
describe("Keamanan & Pencegahan Injeksi", () => {
  describe("Sanitasi CSV (Formula Injection)", () => {
    ...
    it("menambahkan petik tunggal jika diawali tanda tambah (+)", () => {
      // Petik tunggal menempel langsung pada nilainya, tanpa spasi. Menyisipkan
      // spasi akan mengubah isi data yang diekspor, dan itu bukan tujuan
      // sanitasi — cukup membuat spreadsheet membacanya sebagai teks.
